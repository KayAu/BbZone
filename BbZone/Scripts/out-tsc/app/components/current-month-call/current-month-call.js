...
var CurrentMonthCall = /** @class */ (function () {
    function CurrentMonthCall(loaderService, dataService) {
        this.loaderService = loaderService;
        this.dataService = dataService;
        this.activities = [];
    }
    CurrentMonthCall.prototype.ngOnInit = function () {
        this.currentMonth = (new Date()).toLocaleString('default', { month: 'short' }) + ' ' + (new Date()).getFullYear().toString();
        this.loadData();
    };
    CurrentMonthCall.prototype.loadData = function () {
        var _this = this;

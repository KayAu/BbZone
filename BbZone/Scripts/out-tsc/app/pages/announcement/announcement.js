...
var NewAnnouncement = /** @class */ (function () {
    function NewAnnouncement(loaderService, dataService, formEvent, router, route, toastr) {
    ...
    NewAnnouncement.prototype.ngOnInit = function () {
        this.formFields = this.getFormFeldsMapping();
        this.loadApplication(this.route.snapshot.params.id);
    };
    NewAnnouncement.prototype.getFormFeldsMapping = function () {
    ...
    NewAnnouncement.prototype.create = function () {
        var _this = this;
    ...
    NewAnnouncement.prototype.loadApplication = function (applicationId) {
        var _this = this;
    ...
    ], NewAnnouncement.prototype, "form", void 0);
    NewAnnouncement = __decorate([
        core_1.Component({
...
exports.NewAnnouncement = NewAnnouncement;

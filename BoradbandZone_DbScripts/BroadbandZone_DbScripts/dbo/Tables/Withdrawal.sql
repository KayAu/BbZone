CREATE TABLE [dbo].[Withdrawal] (
    [WithdrawalId]  INT           IDENTITY (1, 1000) NOT NULL,
    [ApplicationId] VARCHAR (800) NOT NULL,
    ...
    CONSTRAINT [CK_WithdrawalStatus] CHECK ([Status]='Pending' OR [Status]='Processing' OR [Status]='Cancelled' OR [Status]='Completed' OR [Status]='OnHold')
);
